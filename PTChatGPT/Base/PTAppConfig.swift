...
class PTAppConfig {
    ...
    var language:OSSVoiceEnum = UserDefaults.standard.value(forKey: uLanguageKey) == nil ? .ChineseSimplified : UserDefaults.standard.value(forKey: uLanguageKey) as! OSSVoiceEnum
